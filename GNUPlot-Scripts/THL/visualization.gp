...
plot "data.dat" using 1:($2/10) axes x1y1 with lines \
     ls 1 title "{/Arial=12 Humidity/10}",\
     "data.dat" using 1:3 axes x1y1 with lines \
     ls 2 title "{/Arial=12 Light}",\
     "data.dat" using 1:($4/50) axes x1y1 with lines \
     ls 3 title "{/Arial=12 Temp/50}",\
